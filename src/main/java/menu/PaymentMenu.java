...
public class PaymentMenu {
    ...
    public PaymentMenu(Input input, Message message, LoanService loanService, UserSession userSession, InstallmentService installmentService, CardService cardService, StudentService studentService) {
        INPUT = input;
        MESSAGE = message;
